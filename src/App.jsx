...
export default function App() {
  return (
    <main className="flex min-h-screen flex-col items-center bg-white overflow-hidden relative">
      ...
      <div className="w-full max-w-4xl mx-auto pt-16 pb-8 px-4 sm:px-6 relative z-10">
        ...
        <div className="bg-[#E91E63] rounded-3xl p-6 pb-12 text-white relative overflow-hidden">
          {/* Date and time */}
          <div className="text-center mb-4">
            <h2 className="text-[#FFEB3B] font-bold text-xl md:text-2xl tracking-wide">
          ...
          <div className="flex justify-center mb-1">
            <div className="bg-[#FFEB3B] px-6 py-2 rounded-lg transform rotate-1 shadow-md">
